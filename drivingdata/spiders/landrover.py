...
class LandroverSpider(scrapy.Spider):
    name = 'landrover'
    debug = True
    external_hosting_url = 'https://drivingdata.com.au/facebook/landrover/images'
    allowed_domains = ['quote.landrover.com.au']

    max_images = 5

    def start_requests(self):
        with open('dealers/LandroverDealers.csv', encoding = "ISO-8859-1") as csvfile:
